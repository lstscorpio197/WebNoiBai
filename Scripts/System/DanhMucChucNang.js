    ...
    var $page = {
        ...
        initValidate: function () {
            $form.validate({
                ...
                messages: {
                    ViewName: {
                        required: "Tiêu đề hiển thị không được để trống"
                    },
                    UrlLink: {
                        required: "Link đường dẫn không được để trống"
                    },
                    Controller: {
                ...
                if (res.IsOk) {
                    ...
                    for (let item of data) {
                        ...
                        html += `<tr class="TR_${item.Id}">` +
                            ...
                            `</td>` +
                            `<td class=""><span>${item.ViewName}</span></td>` +
                            `<td class=""><span>${item.UrlLink}</span></td>` +
                            `<td class=""><span>${item.Controller}/${item.ActionDefault}</span></td>` +
                            `<td class="text-center"><span>${item.Sort}</span></td>` +
