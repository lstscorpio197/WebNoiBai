...
namespace WebNoiBai.Models
{
    ...
    public partial class DataXNCEntities : DbContext
    {
        ...
        public virtual DbSet<chuyenbay_hanhkhach_data_backup> chuyenbay_hanhkhach_data_backup { get; set; }
        public virtual DbSet<chuyenbay_hh> chuyenbay_hh { get; set; }
        public virtual DbSet<chuyenbay_hh_data_backup> chuyenbay_hh_data_backup { get; set; }
        public virtual DbSet<chuyenbay_pnr> chuyenbay_pnr { get; set; }
        public virtual DbSet<chuyenbay_pnr_data_backup> chuyenbay_pnr_data_backup { get; set; }
        public virtual DbSet<chuyenbay_tobay> chuyenbay_tobay { get; set; }
        public virtual DbSet<chuyenbay_tobay_data_backup> chuyenbay_tobay_data_backup { get; set; }
        public virtual DbSet<chuyenbay_vandon> chuyenbay_vandon { get; set; }
        public virtual DbSet<chuyenbay_vandon_data_backup> chuyenbay_vandon_data_backup { get; set; }
        public virtual DbSet<hang_hang_khong> hang_hang_khong { get; set; }
        public virtual DbSet<hanhkhach_noichuyen> hanhkhach_noichuyen { get; set; }
